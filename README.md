...
> A practical academic project focused on digital awareness, online professionalism, communication etiquette, collaboration tools, and cyber safety.
...
This project was completed as part of the **Digital Literacy** course to develop practical knowledge of essential digital skills required in academic and professional life.

The project was designed around the role of a **Student Digital Ambassador**, with the objective of promoting responsible, safe, and effective use of digital platforms among students.

It focuses on key areas such as:

- Digital awareness and online responsibility  
...
- To build a basic **professional online identity**
- To explore **coding and collaboration platforms**
- To learn **professional communication and email etiquette**
...
Created and updated student profiles on:   
...
Solved one beginner-level coding challenge on HackerRank    
...
A professional email to a professor requesting an assignment extension    
...
Creating awareness content using digital tools    
Building a professional online presence                
Using coding and collaboration platforms for learning      
Writing professional emails with proper etiquette     
Identifying and preventing common cybercrimes     
🏁 Final Submission      

This repository contains all the required files, screenshots, written content, project report, and supporting materials for the CSE0001 Digital Literacy Project.     

It reflects my learning journey in developing digital awareness, communication skills, and cyber safety knowledge as a student.     
